...
function Login() {
    ...
    return (
        <>
            <Header />
            {/* <form action className="form_main" onSubmit={submit}>
                ...
                <div className="inputContainer">
                    ...
                    <input type="text" className="inputField" id="username" placeholder="Username" onChange={(e) => setUserName(e.target.value)} value={userName} style={{color : 'black'}}/>
                </div>
                <div className="inputContainer">
                    <svg className="inputIcon" xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="#2e2e2e" viewBox="0 0 16 16">
